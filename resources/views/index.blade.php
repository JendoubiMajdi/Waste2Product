...
@section('content')
    <main class="main">
      ...
      <section id="hero" class="hero section dark-background">
        ...
        <div class="hero-background">
          <img src="assets/img/bg/bg-1.jpg" alt="" data-aos-duration="1000">
    ...
    <section id="pricing" class="pricing section">
      ...
      <div class="container section-title">
        <h2>Pricing</h2>
        <p>Transparent service pricing for collection, processing, and recycled-product options to fit small and large partners.</p>
      </div><!-- End Section Title -->
  ...
  <p>Answers about collection logistics, acceptable materials, and how recycled products are developed from local waste.</p>
      </div><!-- End Section Title -->
          ...
          <div class="row g-0">
            <div class="col-lg-7">
              <div class="cta-content p-5">
                ...
                <p class="mb-4">Join our initiative to collect, recycle and repurpose local waste — we turn discarded materials into new revenue streams and products.</p>
                  ...
                  <div class="col-md-6">
                    <div class="benefit-item">
                      ...
                      <div class="benefit-content">
                        <h5>Quick Setup</h5>
                        <p>Rapid deployment of collection points and on-demand pickups for efficient recovery.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
    ...
    <section id="portfolio" class="portfolio section">
      ...
      <div class="container section-title">
  <h2>Portfolio</h2>
  <p>Examples of recycled-material products and successful waste-to-product projects we've delivered.</p>
      </div><!-- End Section Title -->
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title">
        <h2>Contact</h2>
        <p>Waste2Product connects waste collectors and recyclers to transform waste into usable products — get in touch to collaborate or learn more.</p>
      </div><!-- End Section Title -->

      <div class="container">
        <div class="contact-main-wrapper">
          <div class="map-wrapper">
            <iframe src="https://www.google.com/maps?q=Esprit%20El%20Ghazela%2C%20Ariana%2C%20Tunisia&output=embed" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          ...
          <div class="contact-content">
            <div class="contact-cards-container">
              <div class="contact-card">
                ...
                <div class="contact-text">
                  <h4>Location</h4>
                  <p>Esprit El Ghazela, Ariana, Tunisia</p>
                </div>
              </div>
              ...
              <div class="contact-card">
                ...
                <div class="contact-text">
                  <h4>Email</h4>
                  <p>waste2product@waste2product.com</p>
                </div>
              </div>
            ...
            <div class="contact-form-container">
              <h3>Get in Touch</h3>
              <p>Tell us about waste streams you can provide, volumes, or partnership ideas. Our team transforms collected waste into reusable materials and products.</p>
