(function ($) {
    ...
    // Initiate the wowjs (check if WOW is defined)
    ...
    // Facts counter (check if counterUp is available)
    if ($.fn.counterUp) {
    ...
    // Donation progress (check if waypoint is available)
    if ($.fn.waypoint) {
    ...
    // Header carousel (check if owlCarousel is available)
    if ($.fn.owlCarousel) {
